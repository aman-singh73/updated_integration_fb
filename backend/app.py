...
# @app.route('/')
# def home():
#     return "Welcome to the Solar Estimation API"
...
#         image_path = os.path.join(app.config['UPLOAD_FOLDER'], f'{user_id}_satellite_image.png')
#         image.save(image_path)
...
#         print(f"Error saving polygon and image: {str(e)}")
#         db.session.rollback()
#         return jsonify({'error': str(e)}), 500
